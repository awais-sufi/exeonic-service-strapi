...
export interface ApiFaqFaq extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::faq.faq'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    question: Schema.Attribute.Component<'components.faq', true>;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    lasttext: Schema.Attribute.Text;
    link: Schema.Attribute.Component<'components.clicklink', true>;
    link1: Schema.Attribute.Component<'components.clicklink', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiProvideProvide extends Struct.SingleTypeSchema {
  collectionName: 'provides';
  info: {
    displayName: 'provide';
    pluralName: 'provides';
    singularName: 'provide';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    provide: Schema.Attribute.Component<'components.provide', true>;
    publishedAt: Schema.Attribute.DateTime;
    subHeading: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::provide.provide': ApiProvideProvide;
